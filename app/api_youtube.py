...
from verification.playlist_verification import verificar_e_inserir_log #4
from youtube.load_video import load_video_data #4.1
from insertion.blog_post_insertion import insert_blog_post #5
